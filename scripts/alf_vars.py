...
class ALFVAR(object):
    ...
    def __init__(self):
        ...
        self.mypi   = 3.14159265  # pi
        self.clight = 2.9979e10  # speed of light (cm/s)
        self.msun   = 1.989e33  # Solar mass in grams
        self.lsun   = 3.839e33  # Solar luminosity in erg/s
        self.pc2cm  = 3.08568e18  # cm in a pc
        self.huge_number = 1e33  # define small and large numbers
        self.tiny_number = 1e-33
